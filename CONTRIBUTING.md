...
This document explains the processes and practices recommended for contributing enhancements to the GitHub Actions Exporter charm.

## Overview

- Generally, before developing enhancements to this charm, you should consider [opening an issue
  ](https://github.com/canonical/github-actions-exporter-operator/issues) explaining your use case.
...
- [Fork](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks)
  our [GitHub repository](https://github.com/canonical/github-actions-exporter-operator)
...
OCI image for the GitHub Actions Exporter app, and then upload the image to a MicroK8s registry,
...
cd <project_dir>
rockcraft pack
skopeo --insecure-policy copy --dest-tls-verify=false oci-archive:github-actions-exporter_1.0_amd64.rock docker://localhost:32000/github-actions-exporter:latest
```
...
# Deploy the charm
juju deploy ./github-actions-exporter.charm
```
